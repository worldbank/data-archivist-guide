...
An independent review of the data and metadata is highly recommended prior to publishing the final output. The Appendix provides a blank review form (the [DDI Reviewer's Feedback Form](/appendix/reviewer-feedback-form)) to be used by an external reviewer.
