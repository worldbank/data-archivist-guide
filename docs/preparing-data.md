...
*Example 3* provides further details and describes the steps involved in performing a validation when the identifier is made of multiple variables (see [Section A: Data Validations in Stata](/appendix/stata-validation)).
